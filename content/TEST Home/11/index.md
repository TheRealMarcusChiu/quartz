---
title: "11"
created: 2026-05-17T03:02:05.400-05:00
modified: 2026-05-17T03:02:57.283-05:00
parent: "[[TEST Home]]"
children: []
---
...
- <font style="color: rgb(128,128,128);">𝐏(𝐐|𝐄=𝐞) = <strong>𝛴</strong><sub><strong>𝐡</strong>∊<strong>𝐇 </strong></sub>\[ 𝐏(𝐐</font><font style="color: rgb(128,128,128);">, <strong>𝐇</strong>=<strong>𝐡</strong></font><font style="color: rgb(128,128,128);">, 𝐄=𝐞) \] / 𝐏(𝐄=𝐞)</font>
...
- compute both:
	...
	- <font style="color: rgb(128,128,128);">𝐏(𝐄=𝐞) = <strong>𝛴</strong><sub><strong>𝐪</strong>∊𝐐</sub>𝐏(𝐐=<strong>𝐪</strong>, 𝐄=𝐞)</font>
- then use [[Bayes' Rule／Theorem／Law (Prior - Posterior - Distribution - Likelihood - Probability of Evidence)|Baye's Theorem]]:
	- <font style="color: rgb(128,128,128);">𝐏(𝐐|𝐄=𝐞) = 𝐏(𝐐, 𝐄=𝐞) / 𝐏(𝐄=𝐞)</font>
...
> 1. <strong>𝐅</strong><sub>𝑋𝑖</sub> = collect all functions that contain variable 𝑋<sub>𝑖</sub>
> 2. 𝜙<sub>𝑋𝑖</sub> = 𝛴<sub>𝑑∊𝐷𝑖</sub> \[ product of all factors in <strong>𝐅</strong><sub>𝑋𝑖</sub>\]
> 3. return (<strong>𝐅 </strong>-<strong> 𝐅<sub>𝑋𝑖</sub></strong>) ∪ {𝜙<sub>𝑋𝑖</sub>}
# BE/VE Algorithm - Example Solving Conditional Posterior Query

> [!expand]- Click here to expand...
> Let’s consider the graphical model below
>
> ![[11/example-directed-graph.png|150]]
>
...
> >
> > ![[11/graph-elimination.png|700x107]]
> >
